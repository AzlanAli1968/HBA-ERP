...
async function fetchDocumentPdf(
    ...
    const endpoint =
        type ===
            'INV'
            ? `/whatsapp-bot/documents/invoice/${encodeURIComponent(
                  reference,
              )}/pdf`
            : `/whatsapp-bot/documents/voucher/${encodeURIComponent(
                  reference,
              )}/pdf`;
...
async function fetchLedgerPdf(command) {
    ...
    const endpoint =
        `/whatsapp-bot/documents/ledger/pdf?${params.toString()}`;
...
async function fetchOtherReportPdf(
    ...
    const endpoint =
        `/whatsapp-bot/documents/other-report/pdf?${params.toString()}`;
...
async function createHotelInvoiceFromWhatsApp(
    ...
    try {
        const response =
            await fetch(
                `${ERP_BASE_URL}/whatsapp-bot/documents/invoice/create`,
                {
                    method:
                        'POST',
...
async function createVisaInvoiceFromWhatsApp(
    ...
    try {
        const response =
            await fetch(
                `${ERP_BASE_URL}/whatsapp-bot/documents/invoice/visa/create`,
                {
                    method:
                        'POST',
...
async function addVisaInvoiceLineFromWhatsApp(
    ...
    try {
        const response =
            await fetch(
                `${ERP_BASE_URL}/whatsapp-bot/documents/invoice/${encodeURIComponent(
        ...
        remoteJid,
        {
            text:
                [
                    ...
                    `Rate/Transfer: ${invoice.rate_sar} SAR`,
                    `Vendor: ${invoice.vendor_code}`,
                    `Vendor Amount: ${invoice.vendor_amount_sar} SAR`,
        ...
        remoteJid,
        {
            text:
                [
                    ...
                    `Rate/Transfer: ${command.rate} SAR`,
                    `Vendor: ${command.vendorSuffix}`,
                    `Vendor Amount: ${command.vendorAmount} SAR`,
...
async function createVoucherFromWhatsApp(
    ...
    try {
        const response =
            await fetch(
                `${ERP_BASE_URL}/whatsapp-bot/documents/voucher/create`,
                {
                    method:
                        'POST',
...
async function createJournalVoucherFromWhatsApp(
    ...
    try {
        const response =
            await fetch(
                `${ERP_BASE_URL}/whatsapp-bot/documents/journal-voucher/create`,
                {
                    method:
                        'POST',
...
async function createTransferInvoiceFromWhatsApp(
    ...
    try {
        const response =
            await fetch(
                `${ERP_BASE_URL}/whatsapp-bot/documents/invoice/transfer/create`,
                {
                    method:
                        'POST',
...
async function fetchAccountsByType(
    ...
    const endpoint =
        `/whatsapp-bot/accounts/type/${encodeURIComponent(
            alias,
        )}`;
