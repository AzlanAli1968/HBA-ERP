                        ...
                        {selectedAccount ? (
                            <>
                                ...
                                <div className="overflow-x-auto">
                                    ...
                                    <table className="ledger-table w-full min-w-[1050px] text-sm">
...

                                                                {
                                                                    ...
                                                                    ? (
                                                                        <Link
                                                                            ...
                                                                            className="font-mono text-xs font-semibold text-primary hover:underline print:text-black"
                                                                            title="Open invoice"
                                                                        >
                                                                            {
                                                                                row.voucher_id
