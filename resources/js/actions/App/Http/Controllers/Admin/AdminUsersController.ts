 ...
 * @see app/Http/Controllers/Admin/AdminUsersController.php:17
 * @route '/admin/users'
 */
...
/**
* @see \App\Http\Controllers\Admin\AdminUsersController::store
 * @see app/Http/Controllers/Admin/AdminUsersController.php:31
 * @route '/admin/users'
 */
...
/**
* @see \App\Http\Controllers\Admin\AdminUsersController::update
 * @see app/Http/Controllers/Admin/AdminUsersController.php:58
...
/**
* @see \App\Http\Controllers\Admin\AdminUsersController::destroy
 * @see app/Http/Controllers/Admin/AdminUsersController.php:85
 * @route '/admin/users/{user}'
 */
...
const AdminUsersController = { index, store, update, destroy }
