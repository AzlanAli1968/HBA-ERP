...
/**
* @see \App\Http\Controllers\Admin\AdminRolesController::index
 * @see app/Http/Controllers/Admin/AdminRolesController.php:15
 * @route '/admin/roles'
 */
...
/**
* @see \App\Http\Controllers\Admin\AdminRolesController::store
 * @see app/Http/Controllers/Admin/AdminRolesController.php:25
 * @route '/admin/roles'
 */
...
/**
* @see \App\Http\Controllers\Admin\AdminRolesController::update
 * @see app/Http/Controllers/Admin/AdminRolesController.php:54
...
/**
* @see \App\Http\Controllers\Admin\AdminRolesController::destroy
 * @see app/Http/Controllers/Admin/AdminRolesController.php:81
 * @route '/admin/roles/{role}'
 */
...
const AdminRolesController = { index, store, update, destroy }
